...
export const dataSources: Sources[] = [
  ...
  },
  {
    table_name: "orders",
    columns: {
      attributes: ["order_id", "customer_id", "product_id", "order_date"],
      measures: ["quantity", "total_price"],
      dates: ["order_date"],
    },
  },
  {
    table_name: "expenses",
    columns: {
      attributes: ["expense_id", "category", "vendor", "expense_date"],
      measures: ["amount"],
      dates: ["expense_date"],
    },
  },
  ...
  },
  {
    ...
    columns: {
      attributes: ["product_id", "quantity_in_stock", "last_restock_date"],
      measures: ["minimum_quantity", "maximum_quantity"],
      dates: ["last_restock_date"],
    },
  },
  {
    table_name: "sales",
    columns: {
      attributes: ["sale_id", "customer_id", "product_id", "sale_date"],
      measures: ["quantity_sold", "total_revenue"],
      dates: ["sale_date"],
    },
  },
  {
...
export const allTables = [
  { name: "Customer Table", data: customerTable },
  { name: "Supplier Table", data: supplierTable },
  { name: "Customer Table", data: productTable },
];
...
export const savedAnswers = [
  {
    ...
    description: "Select all records from employees table",
    queryValue: `SELECT * FROM employees;`,
    created: "05/01/2024",
    dataSource: "Customer",
  },
  {
    id: 2,
    name: "SelectEmployeesByDepartmentAndSalary",
    description:
      "Select employees by department ID and salary greater than 50000",
    queryValue: `SELECT first_name, last_name, salary
                 FROM employees
                 WHERE department_id = 10
                   AND salary > 50000;`,
    created: "05/01/2023",
  ...
  {
    id: 3,
    name: "SelectEmployeesAndDepartments",
    description: "Select employees with department names",
    queryValue: `SELECT e.first_name, e.last_name, d.department_name
                 FROM employees e
                 JOIN departments d ON e.department_id = d.department_id;`,
    created: "02/01/2023",
    dataSource: "Orders",
  },
  {
    ...
    description: "Count employees and calculate average salary by department",
    queryValue: `SELECT department_id, COUNT(*) AS num_employees, AVG(salary) AS avg_salary
                 FROM employees
                 GROUP BY department_id;`,
    created: "05/01/2024",
    dataSource: "Expenses",
  ...
  {
    id: 5,
    name: "UpdateEmployeeSalaries",
    description: "Update salaries by 10% for employees hired before 2023",
    queryValue: `UPDATE employees
                 SET salary = salary * 1.1
                 WHERE hire_date < '2023-01-01';`,
    created: "05/01/2024",
    dataSource: "Sales",
